...
exports.default = {
  ...
  methods: {
    ...
    execution: function execution(selected, specifiedString, sourceText) {
      if (selected == ConversionType.DELETE) {
        ...
        var $5bf5fa = exports.default || module.exports;
      
      if (typeof $5bf5fa === 'function') {
        $5bf5fa = $5bf5fa.options;
      }
    
        /* template */
        Object.assign($5bf5fa, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("section", [
    _c("div", { staticClass: "vue" }, [
      ...
      _c("ul", { staticClass: "contents" }, [
        _vm.isActive === 1
          ...
          : _vm.isActive === 2
          ? _c("li", [_vm._v("コンテンツ2コンテンツ2コンテンツ2コンテンツ2")])
          : _vm._e()
      ])
    ])
  ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5bf5fa', $5bf5fa);
          } else {
            api.reload('$5bf5fa', $5bf5fa);
          }
        }
